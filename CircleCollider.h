...
namespace CollisionSystem
{
	...
	public:
		...
		CircleCollider(Vec2 position, float radius, float radiousMutiplier = 1, bool isStatic = false);

		/// <summary>
		/// Update the position of the circle collider.
		/// </summary>
		/// <param name="position">The next position of the circle collider</param>
		void UpdatePosition(Vec2 position) override;
